module github.com/wa12n/terraform-provider-contentstack
...
require (
	...
	github.com/wa12n/contentstack-go-sdk v0.1.0
)

// replace github.com/wa12n/contentstack-go-sdk => ../contentstack-go-sdk
